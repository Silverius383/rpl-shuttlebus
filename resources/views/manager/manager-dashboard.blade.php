...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <form method="post" action="{{ url('/manager/tanggal') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <form method="post" action="{{ url('/manager/rute')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <form method="post" action="{{ url('/manager/institusi')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
