                                ...
                                <form action="{{ url('/home/enquiry')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="destination" id="destination" class="form-control" required>
                                            <option value="" selected="true" disabled="true">Pilih Stasiun Akhir
                                            </option>
                                            @foreach ($stations as $list)
                                            <option value="{{$list->name}}">{{$list->name}}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="travel_date" id="travel_date" type="date" class="form-control"
                                            placeholder="Enter Travel Date" required>
                                    </div>
                                    <input type="submit" class="btn btn-info" value="Search"><strong>&nbsp; Or &nbsp;
                                    </strong><a class="btn btn-primary a-btn-slide-text"
                                        href="{{ route('schedules.all') }}">Show All Schedules</a>
                                </form>
                            </div>
                        </div>
                    </section>
        ...
        <div class="container-fluid mt-2">
            <div class="row">
                ...
                <section class="col-md-5">
                    <div class="card mb-3">
                        <img src="https://www.elsetge.cat/myimg/f/0-7004_blog-post-image-silver-glitter-background-hd.jpg"
                            class="card-img-top">
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input disabled name="customer_id"
                                                    value="{{ ucfirst(Auth::user()->fname) }} {{ ucfirst(Auth::user()->lname) }}"
                                                    type="text" class="form-control" placeholder="Enter Source Address"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input disabled name="bus_id" value="{{ $bus->bus_name }}" type="text"
                                                    class="form-control" placeholder="Enter Bus Name" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly name="price" value="{{ $schedule->price }}" type="text"
                                                    class="form-control" placeholder="Enter Bus Name" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly name="source" value="{{ $schedule->pickup_address }}"
                                                    class="form-control" placeholder="Enter Source Address" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="source">To</label>
                                                <input readonly name="destination"
                                                    value="{{ $schedule->dropoff_address }}" class="form-control"
            ...
            <div class="container-fluid mt-2">
                <div class="row justify-content-center">
                    <section class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h3>Edit Ticket Info</h3>
                            </div>
                            <div class="card-body">
                                <form action="{{ url('/home/booking/'.$booking->booking_id).'/update' }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        for ($i=1; $i<=$bus->total_seats ; $i++) { ?>
                                                 ...
                                                 if(in_array("$i", (array)$bus->seats)){echo "checked"; ?>
                                                            disabled="true"
                                                            <?php } if(in_array("$i", (array)$booking->seats_booked)){echo "checked"; } ?>>{{ $i }}
                                                    </div>
                                                    <?php } ?>
                                                    <div class="col-md-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly name="price" value="{{ $schedule->price }}"
                                                            type="text" class="form-control" required>
                                                    </div> &nbsp; &nbsp;
                                                    <div class="form-group">
                                                        <label for="bus_id">Total</label>
                                                        <input readonly name="total_price"
                                                            value="{{ $booking->total_price }}" type="text"
                                                            class="form-control" placeholder="Enter Bus Name" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="source">From</label>
                                                    <input type="text" name="source" value="{{ $booking->source }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="destination"
                                                        value="{{ $booking->destination }}" class="form-control"
                                                        placeholder="Enter Destination Address" required>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ url('posts/'.$post->id)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$post->title}}" name="title" id="title" type="text"
                                        class="form-control" placeholder="Enter Title">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                                    <input value="{{$post->desc}}" name="desc" id="desc" type="text"
